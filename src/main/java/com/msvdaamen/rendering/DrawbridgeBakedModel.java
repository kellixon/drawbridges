...
public class DrawbridgeBakedModel implements IBakedModel {
    ...
    public DrawbridgeBakedModel(IBakedModel unCamouflagedModel)
    {
    ...
    public static final ModelResourceLocation blockStatesFileName
            = new ModelResourceLocation("drawbridges:drawbridge", "facing=up");

    // create a variant tag (ModelResourceLocation) for our blocks
    public static final ModelResourceLocation variantTag
            = new ModelResourceLocation("drawbridges:drawbridge", "facing=north");
    ...
    private IBakedModel handleBlockState(@Nullable IBlockState iBlockState)
    {
        ...
        if (iBlockState instanceof IExtendedBlockState) {
            ...
            IBlockState copiedBlockIBlockState = iExtendedBlockState.getValue(BlockFacing.COPIEDBLOCK);
            EnumFacing facingState = iExtendedBlockState.getValue(BlockFacing.FACING);
